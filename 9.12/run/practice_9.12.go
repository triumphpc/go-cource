...
Example 9.12: Practice program. Packages

Part 8.
1. Let's create a new package and name it game-roulette
2. Put all the structures necessary for the implementation of the business logic of our game into this package
3. Put all the business logic of the roulette game into this package
4. Add the documentation for this package
5. And create and import our package as a separate module
